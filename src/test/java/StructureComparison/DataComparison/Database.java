...
public class Database {
    ...
    public XSSFSheet ExportDbTableToSheet(String table,String sql) {
        String jdbcURL = "jdbc:mysql://127.0.0.1/customer?autoReconnect=true&useSSL=false";
    ...
    public void writeDataLines(ResultSet result, XSSFWorkbook workbook, XSSFSheet sheet)
            throws SQLException {
        ResultSetMetaData metaData = result.getMetaData();
        int numberOfColumns = metaData.getColumnCount();
